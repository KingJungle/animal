...
class QuestionsViewController: UIViewController {
    ...
    @IBAction func singleAnswerButtonPressed(_ sender: UIButton) {
        ...
        case
            singleButton1: answersChosen.append(currentAnswers[0])
        case
            singleButton2: answersChosen.append(currentAnswers[1])
        case
            singleButton3: answersChosen.append(currentAnswers[2])
        case
            singleButton4: answersChosen.append(currentAnswers[3])
        default:
            break
        }
        nextQuestion()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?){
        if segue.identifier == "Results"{
            let resultviewController1 = segue.destination as! ResultViewController
            resultviewController1.responses = answersChosen
        }
    }
